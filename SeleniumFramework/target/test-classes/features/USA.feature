...
Scenario Outline: Login and editing
    ...
    Then Selecting Start and end date as "Current" 
...
Scenario Outline: Apply and save job
    ...
    #Then Setting Job Serach filter as "<topcategory>" 
...
Examples:
	 | env         | hours     | jobtype   | topcategory                            |
	 | environment | Full-Time | Permanent | Logistics Distribution and Supply Chain|
	
Scenario Outline: Settings and other links
    Given Load the url "<env>"
    Then Clicking on Login button 	 
    Then Setting "Email" in login "txtUserName" from output
    Then Setting "Password" in login "txtPassword"
    ...
    Then Selecting "Spanish" language from dropdown
    Then Clicking on Language Save 
    Then Clicking on "Acerca de" tab
    Then Clicking on "Rastreador de empleos" tab
    Then Clicking on "Centro de asociados" tab
    Then Clicking on "Recursos profesionales" tab
    Then Clicking on "Ajustes" in top toggle
...
Scenario Outline: Change Password
    ...
    Then Clicking on the "loginbtn" button
    Then Clicking on "Job Tracker" tab
    Then Clicking on "Associate Center" tab
